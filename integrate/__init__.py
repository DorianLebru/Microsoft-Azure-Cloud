...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    if upper and lower:
        result = integration_without_N(lower, upper)
        return func.HttpResponse(f"Done : {result}")
    else:
        return func.HttpResponse(
             "This HTTP triggered function executed successfully. Pass a lower and upper value in the query string or in the request body for a personalized response.",
             status_code=200
        )
